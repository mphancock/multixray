...
if __name__ == "__main__":
    ...
    w_xray_df = pd.read_csv(Path(Path.home(), "xray/sample_bench/data/7mhf/178_wxray/best_wxray.csv"), index_col=0)
    ...
    for i in range(len(pdb_files)):
        ...
        params_dict["out_pdb_file"] = None
        params_dict["n_step"] = 15
