...
if __name__ == "__main__":
    m = IMP.Model()
    h = IMP.atom.read_pdb(str(Path(Path.home(), "xray/data/pdbs/3k0m/3k0m.pdb")), m, IMP.atom.NonWaterPDBSelector())
    ...
    IMP.atom.write_pdb(h, str(Path(Path.home(), "xray/data/pdbs/3k0m/3k0m_refine.pdb")))