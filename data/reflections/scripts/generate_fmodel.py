...
if __name__ == "__main__":
    # pdb_file = Path(Path.home(), "xray/data/pdbs/3ca7/3ca7_refine_4.pdb")
    pdb_files = list(Path(Path.home(), "xray/dev/17_synthetic_native/data/pdbs/1_state_ref").glob("*.pdb"))

    for pdb_file in pdb_files:
        model_cif_file = Path(Path.home(), "xray/dev/17_synthetic_native/data/cifs/1_state_ref/{}.cif".format(pdb_file.stem))
